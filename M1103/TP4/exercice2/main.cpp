...
int main()
{
    ...
    unsigned short int deplacementPetit ; // indique la nature du déplacement fait par deplacerPetit
    string kk;                 //pour arrêter les défilements
    ...
    while (true)
    {
        ...
        deplacerPetit (t1, t2, t3, deplacementPetit);
        ...
        deplacerAutre (t1, t2, t3, deplacementPetit);
        //cout << nbreCoups << ".b :  " ;
        cout << "t1 = { " ;
        afficherTour (t1);
        cout << " }    t2 = { " ;
